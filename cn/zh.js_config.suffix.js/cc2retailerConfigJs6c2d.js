bm_jquery.extend(true, bm.namespace("config"), {swipeNav : {"isActive": true},  queryCookieName: "bm_query_cookie" ,carConfigurator : {"appConfig": {"usePushState": true}}, dealerLocator : {
  ...
  "maintenance": {
    "title": "维护中",
    "message": "\n由于技术原因，车辆配置器当前不可用。我们希望尽快解决并恢复服务。\n",
    "reload": "重新加载页面"
    },
  "header": {
    "changeModel": "改变",
  ...
  "mco": {
    "headline": "请注意..",
    "richtext": "\n请注意从公共配置器导入选配时，可能由于区域适用性问题导致某些选择无法显示。如果此配置码为客户提供，请现在公共配置器中寻回以确认车型和选配。比如：如果您的市场无法订购慕尚加长版但客户的配置码为此车型的配置选择，在此配置器寻回时将自动将所有已选配置加载在您所在区域可选购的与慕尚加长版最相近的车型上。 \n",
    "error": {
      "notFound": "车辆配置码无法识别。",
      "emptyField": "请输入车辆配置码"
      },
  ...
  "priceSettings": {
    "headline": "价格设置",
    "labelShowPrices": "显示价格",
    "emptyPrice": "n/a",
    "generalWarningHead": "警告:",
    "generalWarningText": "\n以下的所有信息将用于您本次登录的车辆配置选择。 \n",
    "switchOn": "开启",
    "switchOff": "关闭",
    "addDiscount": "+ 增加行",
    "base": "车辆价格",
    ...
    "error": {
      ...
      "tooManySeperators": "\n仅 \"-\" 和\".\" 或 \",\" 可用, 比如 \"-1234.56\".\n",
      "nonumber": "内容不是数字",
      "invalidRange": "比例须在 -100% 与100%之间。",
      "invalidTax": "税率须为小于 100%的正数比例"
      },
    "button": {
      "submit": "保存并关闭",
      "recalc": "重新计算",
