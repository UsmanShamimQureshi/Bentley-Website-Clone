...
bodyNoScrollClass:"by_e-brochure_overlay__no-scroll",eventNamespace:"by_eBrochure",closeBtnSelector:".by_eb_content_box__close_btn",submitBtnSelector:".by_eb_content_box__btn",contentSelector:".by_eb_content_box__content",contentColsSelector:".by_eb_content_box__content_col",formSelector:".bm_eBrochure__form",submitBtnTextSelector:".by_eb_content_box__btn_text",formGroupSelector:".by_eb__form_group",formGroupInvalidClass:"by_eb__form_group--invalid"};g.prototype={init:function(){this.$body=a(document.body);
this.$closeBtn=this.$el.find(this.options.closeBtnSelector);this.$submitBtn=this.$el.find(this.options.submitBtnSelector);this.$content=this.$el.find(this.options.contentSelector);this.$contentCols=this.$el.find(this.options.contentColsSelector);this.$form=this.$el.find(this.options.formSelector);this.btnLabel=this._getSubmitBtnLabel();this.isVisible()&&this._bindCloseHandler()},initEvents:function(){this.$closeBtn.on("click."+this.options.eventNamespace,this.hide.bind(this));this.$submitBtn.on("click."+
this.options.eventNamespace,this._onSubmitBtnClick.bind(this));if(this.options.id){var a=this;e.on("by_overlay_form_open",function(b,c){c===a.options.id&&a.show(b)})}this.formHelper=new g.FormHelper(this,this.$form,this.options)},_activateDocumentListener:function(){c||(c=!0,e.on("click.by_js_openOverlayForm",".by_js_openOverlayForm",d))},_getSubmitBtnLabel:function(){var a=this.$submitBtn.children(this.options.submitBtnTextSelector);return 0<a.length?a.text():this.$submitBtn.text()},_setSubmitBtnLabel:function(a){var b=
this.$submitBtn.children(this.options.submitBtnTextSelector);0<b.length?b.text(a):this.$submitBtn.text(a)},_onSubmitBtnClick:function(){this.$submitBtn.hasClass(this.options.submitBtnDisabledClass)||0!==this.$form.length||setTimeout(this.hide.bind(this),250)},show:function(a){a.preventDefault();this.$body.hasClass(this.options.bodyNoScrollClass)||(this.pageScrollPosition=window.pageYOffset,this.$body.addClass(this.options.bodyNoScrollClass),this.$body.css({top:"-"+this.pageScrollPosition+"px"}),this.$el.removeClass(this.options.hiddenClassName),
this._bindCloseHandler())},hide:function(){this.$body.removeClass(this.options.bodyNoScrollClass);this.$body.css({top:""});window.scrollTo(0,this.pageScrollPosition);this.$el.addClass(this.options.hiddenClassName);this.$el.find(".by_eb_content_box__content_overlay").remove();this.$contentCols.removeClass("by_hidden");this._reset();this._setSubmitBtnLabel(this.btnLabel);this.$submitBtn.removeAttr("href");e.off("keyup.bm_overlayForm")},isVisible:function(){return!this.$el.hasClass(this.options.hiddenClassName)},
_reset:function(){this.$form.length&&(this.$form[0].reset(),this.formHelper.reset(),this.$el.find("."+this.options.formGroupInvalidClass).removeClass(this.options.formGroupInvalidClass),a(this.$form[0].elements).off("input.overlayForm"))},_bindCloseHandler:function(){var a=this;e.off("keyup.bm_overlayForm");e.on("keyup.bm_overlayForm",function(b){"Escape"===b.key&&a.hide()})}};a.fn.bm_overlayForm=function(a){this.each(function(){b.push(new g(this,a))})};a.fn.bm_overlayForm.pluginClass=g;g.FormHelper=
function(a,b,c){this.overlayFormInstance=a;this.$form=b;this.form=b.get(0);this.options=c;this.initEvents()};g.FormHelper.prototype={reset:function(){},initEvents:function(){this.$form.on("submit",this._onFormSubmit.bind(this));this.overlayFormInstance.$content.on("click",".by_js_confirm__btn",this._onFailureConfirmBtnClick.bind(this))},_onFormSubmit:function(b){b.preventDefault();if(!this.overlayFormInstance.$submitBtn.hasClass(this.overlayFormInstance.options.submitBtnDisabledClass))if(b=this.form,
b.checkValidity())this._changeSubmitBtnState(!0),this._submitForm();else for(var c,e=this,d=function(){a(this).closest(e.options.formGroupSelector).toggleClass(e.options.formGroupInvalidClass,!this.checkValidity())},f=0;f<b.elements.length;f++)c=a(b.elements.item(f)),b.elements.item(f).checkValidity()||c.closest(this.options.formGroupSelector).addClass(this.options.formGroupInvalidClass),c.on("input.overlayForm",d)},_submitForm:function(){for(var b=this.form,c,e={},d=0;d<b.elements.length;d++)c=this._getFieldValue(b.elements.item(d)),
null!==c&&(e[c.name]=c.value);a.ajax({url:b.action,method:b.method,data:e,success:bm.utils.debounce(this._onResponse.bind(this),400),error:bm.utils.debounce(this._onResponse.bind(this),400)})},_getFieldValue:function(b){return b.name&&a(b).is(":visible")?"radio"!==b.getAttribute("type")||b.checked?{name:b.name,value:b.value}:null:null},_changeSubmitBtnState:function(a){this.$form.find(this.options.submitBtnSelector).prop("disabled",a).toggleClass(this.options.submitBtnDisabledClass,a)},_onResponse:function(b){var c=
{};try{c="responseText"in b?JSON.parse(b.responseText):b}catch(r){}b=this.overlayFormInstance.$el.find(".by_eb__response-tpl");var e=a(a.parseHTML(b.html())),d=this;setTimeout(function(){d._changeSubmitBtnState(!1)},750);c&&(e.find(".by_eb__response_h").text(c.title),e.find(".by_eb__response_p").html(c.text),e.find(".by_eb_content_box__btn").toggleClass("by_eb_content_box__btn--hidden",!c.button).text(c.button));c="by_eb__response_icon_container--"+(c.success?"success":"error");e.find(".by_eb__response_icon_container").addClass(c);
setTimeout(function(){e.addClass("by_eb_content_box__content_overlay--visible")},250);this.overlayFormInstance.$contentCols.addClass("by_hidden");this.overlayFormInstance.$content.append(e)},_onFailureConfirmBtnClick:function(){this.overlayFormInstance.$contentCols.removeClass("by_hidden");this.overlayFormInstance.$content.find(".by_eb_content_box__content_overlay").remove()}}})(bm_jquery);
