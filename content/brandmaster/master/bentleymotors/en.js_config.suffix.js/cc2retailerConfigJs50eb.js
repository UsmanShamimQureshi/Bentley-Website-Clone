bm_jquery.extend(true, bm.namespace("config"), {swipeNav : {"isActive": true},  queryCookieName: "bm_query_cookie" ,carConfigurator : {"appConfig": {"usePushState": true}}, dealerLocator : {
  ...
  "maintenance": {
    ...
    "message": "\nDue to a technical issue the Retailer Configurator is offline. We hope to have this resolved shortly.\n",
    "reload": "Reload Page"
    },
  "header": {
    "changeModel": "Change",
  ...
  "boom": {
    ...
    "placeholder": "\nThis field will be passed to BOOM. Please enter customer name associated with this enquiry *Where selected, any accessories that are available in BOOM will be supplied and invoiced to you separately. All other accessories included in this specification must be ordered through POPIMS via your Parts Department.\n",
  ...
  "mco": {
    ...
    "richtext": "\nPlease note that when entering a Bentley Code originating from the Public Configurator that some features may not carry over into your Retailer Configurator due to regional options and features. If entering a code provided by a customer, please also load it into the Public Configurator to ensure the correct model and features are being accounted for. For example, if your market does not offer Mulsanne EWB but a customer provides a code for one, the paint, hide, veneer etc will be transferred to a model that is offered in your region.\n",
    "error": {
  ...
  "priceSettings": {
    ...
    "generalWarningText": "\nAny entries entered below will be carried to your next configuration whilst in the same session.\n",
    "switchOn": "On",
    "switchOff": "Off",
    "addDiscount": "+ Add Row",
    "base": "Base Price",
    ...
    "error": {
      ...
      "tooManySeperators": "\nOnly \"-\" and \".\" or \",\" are allowed, e.g. \"-1234.56\".\n",
